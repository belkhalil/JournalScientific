...
<html ng-app="myapp">
    ...
    <body ng-controller="userController">
        <%
            ...
            pageContext.setAttribute("amis", auteurDAO.allAuteur());
            ...
            <c:forEach items="${amis}" var="ami">
                <div class="panel panel-default">
                    <div class="panel-body">  
                        ...
                        <a href="AmisController.jsp?idC=${auteur.getId()}&idA=${ami.getId()}" class="btn btn-default btn-flat" style="float: right">Ajouter</a>
                    </div>  
                </div>
            </c:forEach>
        </div>
